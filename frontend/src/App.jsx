        ...
        {activeTab === 'Dashboard' && (
          <header className="px-6 pt-5 pb-2 flex justify-between items-start flex-shrink-0 bg-transparent">
            ...
            <div className="flex items-center space-x-3">
              {/* LIVE vs MOCK Data Feed Status Badge */}
              {selectedDate?.startsWith('2026') ? (
                ...
                <span className="inline-flex items-center px-2.5 py-1 rounded-md text-[11px] font-extrabold bg-amber-500/15 text-amber-400 border border-amber-500/40 tracking-wider">
